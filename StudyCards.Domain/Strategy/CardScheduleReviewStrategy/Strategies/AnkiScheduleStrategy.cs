...
using StudyCards.Domain.State.AnkiScheduleState.States;
...
public class AnkiScheduleStrategy : ICardScheduleStrategy
{
    ...
    {
        // todo inject with DI
        var stateMachine = new AnkiReviewStateMachine();
        return stateMachine.Schedule(card, difficulty, repeatCount);
